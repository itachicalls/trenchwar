...
func _show_main_menu() -> void:
	...
	if Game.compact_ui():
		...
		_spacer(box, 10)
		_subtitle(box, "ONLINE PVP  ·  WAGER SOL\nWinner takes the pot.", 18, Color(0.95, 0.82, 0.35))
		_spacer(box, 18)
		_button(box, "PLAY ONLINE / WAGER SOL", _show_online_lobby, Color(0.95, 0.78, 0.25))
		...
		_spacer(box, 10)
		_subtitle(box, "ONLINE PVP  ·  WAGER SOL  ·  WINNER TAKES THE POT", 18, Color(0.95, 0.82, 0.35))
		_spacer(box, 20)
		_button(box, "PLAY ONLINE / WAGER SOL", _show_online_lobby, Color(0.95, 0.78, 0.25))
